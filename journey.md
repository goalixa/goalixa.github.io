...
<div class="journey-intro">
  <p>This is the narrative story of how Goalixa evolved from a concept to a production-ready productivity platform. Each chapter represents a phase of the journey, with personal reflections and technical details.</p>
</div>
...
**Key Posts in this Chapter**:
- [Survive in War Time](#/posts/goalixa-story/survive-in-war-time.md) - The reality of building with restricted internet
- [Learning in Wartime: Preparing Goalixa Infrastructure](#/posts/goalixa-story/learning-in-wartime-kubernetes-plan.md) - How I used downtime to study Kubernetes, Cilium, and service mesh
...
**Key Posts in this Chapter**:
- [Migrate Monolithic to Microservice](#/posts/migrate-monolithic-to-microservice.md) - Why the old architecture couldn't scale
- [From Fragmented UIs to One PWA](#/posts/api-gateway-pwa-microservices.md) - The decision to unify the frontend
- [Why Most Goalixa Code Is AI-Developed](#/posts/why-goalixa-is-ai-developed.md) - My philosophy on AI-assisted development
...
**Key Posts in this Chapter**:
- [Migrate Monolithic to Microservice](#/posts/migrate-monolithic-to-microservice.md) - The migration plan
- [Future Plan: Event-Driven Architecture with NATS](#/posts/event-driven-architecture-nats.md) - Next steps for time-based features
...
**Key Posts in this Chapter**:
- [ArgoCD Setup: First Step](#/posts/gitops/argocd-first-step.md) (Part 1) - Initial bootstrap and setup
- [ArgoCD Applications and Sync Strategy](#/posts/gitops/argocd-applications-sync-strategy.md) (Part 2) - Defining applications and sync behavior
...
**Key Posts in this Chapter**:
- [Why Goalixa Needs a Staging Environment](#/posts/devops/why-staging-with-kustomize.md) - Kustomize plan for safe deployments
- [Monitoring Stack Setup: Prometheus, Grafana, Alertmanager](#/posts/monitoring-stack-prometheus-grafana-alertmanager.md) - Observability foundation
- [Using Claude to Speed Up Goalixa Development](#/posts/software-engineering/using-claude-for-goalixa.md) - AI-assisted workflow
...
**Want the technical timeline?** See the [Timeline page](#/timeline.md) for chronological post listings.

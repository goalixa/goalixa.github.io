...
description: 'Unified API gateway pattern for PWA and microservices architecture.'
---
...
<Callout type="info">
**💡 Key Insight:** The API Gateway/BFF pattern isn't just about routing - it's about creating a clean separation between frontend and backend concerns while maintaining a unified user experience.
</Callout>
...
**⚠️ Security Note:** Never rely solely on frontend authentication. Always enforce authorization in your backend services to prevent unauthorized access.
</Callout>

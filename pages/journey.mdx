...
**Key Posts in this Chapter**:
- [Migrate Monolithic to Microservice](/posts/migrate-monolithic-to-microservice) - Why the old architecture couldn't scale
- [From Fragmented UIs to One PWA](/posts/api-gateway-pwa-microservices) - The decision to unify the frontend
- [Why Most Goalixa Code Is AI-Developed](/posts/why-goalixa-is-ai-developed) - My philosophy on AI-assisted development
...
**Key Posts in this Chapter**:
- [Migrate to PWA Successfully](/posts/migrate-to-pwa-success-fully) - The milestone celebration post
- [BFF in Goalixa: How PWA and Services Stay Clean](/posts/bff-goalixa) - Backend For Frontend pattern explanation
- [Removing UI from Legacy Services](/posts/removing-ui-from-legacy-auth-redirection) - Cleaning up auth flows
...
**Key Posts in this Chapter**:
- [Migrate Monolithic to Microservice](/posts/migrate-monolithic-to-microservice) - The migration plan
- [Future Plan: Event-Driven Architecture with NATS](/posts/event-driven-architecture-nats) - Next steps for time-based features
...
**Key Posts in this Chapter**:
- [Incident Report: PWA Path Change Caused High Latency](/posts/incident-reports/pwa-path-latency-incident) ⚠️ - Full incident timeline and impact
- [Latency Taught Me Better Software Engineering](/posts/software-engineering/latency-taught-me-better-software-engineering) - The engineering mindset shift
...
**Key Posts in this Chapter**:
- [Why Goalixa Needs a Staging Environment](/posts/devops/why-staging-with-kustomize) - Kustomize plan for safe deployments
- [Monitoring Stack Setup: Prometheus, Grafana, Alertmanager](/posts/monitoring-stack-prometheus-grafana-alertmanager) - Observability foundation
- [Using Claude to Speed Up Goalixa Development](/posts/software-engineering/using-claude-for-goalixa) - AI-assisted workflow

...
- **Haigh Availability**: Running multiple Vault pods for redundancy
...
> **Note**: Vault unseal keys and root tokens should be stored securely outside of version control. Never commit real credentials to a repository.
...
- [ArgoCD First Step](/posts/gitops/argocd-first-step.md)
